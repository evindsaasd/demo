...
<template>
  <div>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="id" label="id" width="180" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="username" label="username" width="118" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="className" label="className" width="300" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="methodName" label="methodName" width="140" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="args" label="args" width="150" show-overflow-tooltip>
      </el-table-column>
...
<script>
import { OrderList, OrderRefund, OrderDelete,GetLogs } from '../api/payMG'
